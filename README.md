...
- runtime bundle generation, wrapper helpers, direct session-spawn payload preparation, hybrid persistent/ephemeral topology, and OpenClaw spawn integration helpers for deployed archetype sessions
