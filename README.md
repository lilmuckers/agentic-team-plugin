...
- runtime bundle generation, wrapper helpers, direct session-spawn payload preparation, and hybrid persistent/ephemeral topology for deployed archetype sessions
